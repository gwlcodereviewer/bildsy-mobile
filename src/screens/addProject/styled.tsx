...
export const RadioExtraView = styled.View`
  margin-top: ${rh(-3)}px;
`;
...
export const BottomCardContainer = styled.View`
  ...
  width: 48%;
`;
export const FullWidthBottomCardContainer = styled.View`
  flex-direction: column;
  flex-wrap: wrap;
  justify-content: flex-start;
`;
...
`;
export const ContainerDetailsText = styled.View`
  flex-direction: row;
`;
...
export const DetailsTitle = styled.Text<IFontSize>`
  ...
  padding-right: ${rw(10)}px;
`;
export const FullWidthDetailsText = styled.Text<IFontSize>`
  font-family: ${FontFamily.sourceSansProRegular};
  font-size: ${props => (props.fontSize ? rpx(props.fontSize) : rpx(14))}px;
  color: ${colors.grey};
  flex-wrap: wrap;
...
export const AttachmentListContainer = styled.TouchableOpacity`
  ...
  margin-top: ${rh(20)}px;
`;
export const AttachmentListEditContainer = styled.View`
  margin-left: ${rw(20)}px;
  margin-right: ${rw(20)}px;
  margin-top: ${rh(30)}px;
  justify-content: center;
...
export const AttachmentListContainerPopUp = styled.View`
  margin-left: ${rw(20)}px;
  margin-right: ${rw(20)}px;
  margin-top: ${rh(30)}px;
  justify-content: center;
...
export const AttachmentNameContainer = styled.View`
  flex: 1;
  flex-direction: row;
...
export const MainLoaderContainer = styled.View`
  ...
  flex: 1;
`;
export const FullWidthDetailsTitle = styled.Text<IFontSize>`
  font-family: ${FontFamily.sourceSansProRegular};
  font-size: ${props => (props.fontSize ? rpx(props.fontSize) : rpx(14))}px;
  color: ${colors.black};
  flex-wrap: wrap;
  ...
  padding-right: ${rw(10)}px;
`;
export const BudgetRowContainer = styled.View`
  flex-direction: row;
  align-items: center;
  flex: 1;
`;
